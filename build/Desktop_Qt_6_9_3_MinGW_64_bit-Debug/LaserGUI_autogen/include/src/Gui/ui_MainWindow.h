...
public:
    ...
    QGroupBox *gb_PowerCheck_3;
    QVBoxLayout *verticalLayout_22;
    QFrame *frame_LaserMeter_2;
    ...
    QFrame *frame_ThorMeter_2;
    QHBoxLayout *horizontalLayout_33;
    QLabel *labelPowerTitle_5;
    QLabel *lbl_measPower_2;
    QLabel *lblUnit_5;
    ...
    QLabel *lblStatusMeter_4;
    QFrame *frame_ThorMeter;
    QHBoxLayout *layoutPower_2;
    QLabel *labelPowerTitle_4;
    QLabel *lbl_measPower;
    QLabel *lblUnit_4;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayout_40->setContentsMargins(10, 10, 10, 10);
        ...
        horizontalLayout_40->addWidget(btnPInit);

        gb_PowerCheck_3 = new QGroupBox(Page_Auto);
        gb_PowerCheck_3->setObjectName("gb_PowerCheck_3");
        QSizePolicy sizePolicy1(QSizePolicy::Policy::Preferred, QSizePolicy::Policy::Preferred);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(gb_PowerCheck_3->sizePolicy().hasHeightForWidth());
        gb_PowerCheck_3->setSizePolicy(sizePolicy1);
        verticalLayout_22 = new QVBoxLayout(gb_PowerCheck_3);
        verticalLayout_22->setObjectName("verticalLayout_22");
        frame_LaserMeter_2 = new QFrame(gb_PowerCheck_3);
        frame_LaserMeter_2->setObjectName("frame_LaserMeter_2");
        QSizePolicy sizePolicy2(QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Preferred);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(frame_LaserMeter_2->sizePolicy().hasHeightForWidth());
        frame_LaserMeter_2->setSizePolicy(sizePolicy2);
        frame_LaserMeter_2->setMinimumSize(QSize(300, 0));
        frame_LaserMeter_2->setMaximumSize(QSize(300, 16777215));
        frame_LaserMeter_2->setLayoutDirection(Qt::LayoutDirection::LeftToRight);
        horizontalLayout_34 = new QHBoxLayout(frame_LaserMeter_2);
        horizontalLayout_34->setSpacing(1);
        horizontalLayout_34->setObjectName("horizontalLayout_34");
        horizontalLayout_34->setContentsMargins(1, 1, 1, 1);
        labelPowerTitle_3 = new QLabel(frame_LaserMeter_2);
        ...
        labelPowerTitle_3->setAlignment(Qt::AlignmentFlag::AlignCenter);
        labelPowerTitle_3->setMargin(-5);
        labelPowerTitle_3->setIndent(-5);

        horizontalLayout_34->addWidget(labelPowerTitle_3);

        lblPower_3 = new QLabel(frame_LaserMeter_2);
        ...
        lblPower_3->setMargin(5);
        lblPower_3->setIndent(5);

        horizontalLayout_34->addWidget(lblPower_3);

        lblUnit_3 = new QLabel(frame_LaserMeter_2);
        ...
        lblUnit_3->setMargin(-1);
        lblUnit_3->setIndent(-1);

        horizontalLayout_34->addWidget(lblUnit_3);

        horizontalLayout_34->setStretch(0, 2);
        horizontalLayout_34->setStretch(1, 5);
        horizontalLayout_34->setStretch(2, 1);

        verticalLayout_22->addWidget(frame_LaserMeter_2, 0, Qt::AlignmentFlag::AlignHCenter);


        horizontalLayout_40->addWidget(gb_PowerCheck_3);

        groupBox_3 = new QGroupBox(Page_Auto);
        ...
        frame_ThorMeter_2 = new QFrame(groupBox_3);
        frame_ThorMeter_2->setObjectName("frame_ThorMeter_2");
        sizePolicy2.setHeightForWidth(frame_ThorMeter_2->sizePolicy().hasHeightForWidth());
        frame_ThorMeter_2->setSizePolicy(sizePolicy2);
        frame_ThorMeter_2->setMinimumSize(QSize(300, 0));
        frame_ThorMeter_2->setMaximumSize(QSize(300, 16777215));
        frame_ThorMeter_2->setLayoutDirection(Qt::LayoutDirection::LeftToRight);
        horizontalLayout_33 = new QHBoxLayout(frame_ThorMeter_2);
        horizontalLayout_33->setSpacing(1);
        horizontalLayout_33->setObjectName("horizontalLayout_33");
        horizontalLayout_33->setContentsMargins(1, 1, 1, 1);
        labelPowerTitle_5 = new QLabel(frame_ThorMeter_2);
        labelPowerTitle_5->setObjectName("labelPowerTitle_5");
        sizePolicy1.setHeightForWidth(labelPowerTitle_5->sizePolicy().hasHeightForWidth());
        labelPowerTitle_5->setSizePolicy(sizePolicy1);
        QFont font6;
        font6.setPointSize(30);
        font6.setBold(false);
        labelPowerTitle_5->setFont(font6);
        labelPowerTitle_5->setAlignment(Qt::AlignmentFlag::AlignCenter);
        labelPowerTitle_5->setMargin(-5);
        labelPowerTitle_5->setIndent(-5);

        horizontalLayout_33->addWidget(labelPowerTitle_5);

        lbl_measPower_2 = new QLabel(frame_ThorMeter_2);
        lbl_measPower_2->setObjectName("lbl_measPower_2");
        sizePolicy.setHeightForWidth(lbl_measPower_2->sizePolicy().hasHeightForWidth());
        lbl_measPower_2->setSizePolicy(sizePolicy);
        lbl_measPower_2->setFont(font5);
        lbl_measPower_2->setAlignment(Qt::AlignmentFlag::AlignCenter);
        lbl_measPower_2->setMargin(5);
        lbl_measPower_2->setIndent(5);

        horizontalLayout_33->addWidget(lbl_measPower_2);

        lblUnit_5 = new QLabel(frame_ThorMeter_2);
        lblUnit_5->setObjectName("lblUnit_5");
        sizePolicy2.setHeightForWidth(lblUnit_5->sizePolicy().hasHeightForWidth());
        lblUnit_5->setSizePolicy(sizePolicy2);
        lblUnit_5->setFont(font6);
        lblUnit_5->setMargin(-1);
        lblUnit_5->setIndent(-1);

        horizontalLayout_33->addWidget(lblUnit_5);

        horizontalLayout_33->setStretch(0, 2);
        horizontalLayout_33->setStretch(1, 5);
        horizontalLayout_33->setStretch(2, 1);

        verticalLayout_23->addWidget(frame_ThorMeter_2, 0, Qt::AlignmentFlag::AlignHCenter);


        horizontalLayout_40->addWidget(groupBox_3);

        horizontalLayout_40->setStretch(0, 5);
        horizontalLayout_40->setStretch(1, 5);
        horizontalLayout_40->setStretch(2, 5);
        ...
        verticalLayout_19->setStretch(1, 4);
        ...
        sizePolicy3.setHeightForWidth(cbPDx->sizePolicy().hasHeightForWidth());
        cbPDx->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(spL_PD->sizePolicy().hasHeightForWidth());
        spL_PD->setSizePolicy(sizePolicy4);
        ...
        sizePolicy3.setHeightForWidth(dspDT->sizePolicy().hasHeightForWidth());
        dspDT->setSizePolicy(sizePolicy3);
        ...
        sizePolicy2.setHeightForWidth(centralwidget_2->sizePolicy().hasHeightForWidth());
        centralwidget_2->setSizePolicy(sizePolicy2);
        QFont font7;
        font7.setPointSize(12);
        font7.setBold(false);
        centralwidget_2->setFont(font7);
        verticalLayout_18 = new QVBoxLayout(centralwidget_2);
        verticalLayout_18->setObjectName("verticalLayout_18");
        lblStatusMeter_1 = new QLabel(centralwidget_2);
        lblStatusMeter_1->setObjectName("lblStatusMeter_1");

        verticalLayout_18->addWidget(lblStatusMeter_1);

        frame_LaserMeter = new QFrame(centralwidget_2);
        frame_LaserMeter->setObjectName("frame_LaserMeter");
        sizePolicy2.setHeightForWidth(frame_LaserMeter->sizePolicy().hasHeightForWidth());
        frame_LaserMeter->setSizePolicy(sizePolicy2);
        frame_LaserMeter->setMinimumSize(QSize(250, 0));
        frame_LaserMeter->setMaximumSize(QSize(250, 16777215));
        layoutPower = new QHBoxLayout(frame_LaserMeter);
        layoutPower->setSpacing(1);
        layoutPower->setObjectName("layoutPower");
        layoutPower->setContentsMargins(1, 2, 1, 2);
        labelPowerTitle = new QLabel(frame_LaserMeter);
        ...
        font8.setBold(false);
        labelPowerTitle->setFont(font8);
        labelPowerTitle->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        labelPowerTitle->setMargin(0);
        labelPowerTitle->setIndent(1);

        layoutPower->addWidget(labelPowerTitle);

        lblPower = new QLabel(frame_LaserMeter);
        ...
        lblUnit->setFont(font8);
        lblUnit->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);

        layoutPower->addWidget(lblUnit);

        layoutPower->setStretch(0, 3);
        layoutPower->setStretch(1, 3);
        layoutPower->setStretch(2, 1);

        verticalLayout_18->addWidget(frame_LaserMeter);
        ...
        horizontalLayout_39->addWidget(centralwidget_2);

        groupBox_2 = new QGroupBox(tab_Controls);
        groupBox_2->setObjectName("groupBox_2");
        sizePolicy2.setHeightForWidth(groupBox_2->sizePolicy().hasHeightForWidth());
        groupBox_2->setSizePolicy(sizePolicy2);
        verticalLayout_5 = new QVBoxLayout(groupBox_2);
        verticalLayout_5->setObjectName("verticalLayout_5");
        lblStatusMeter_4 = new QLabel(groupBox_2);
        lblStatusMeter_4->setObjectName("lblStatusMeter_4");

        verticalLayout_5->addWidget(lblStatusMeter_4);

        frame_ThorMeter = new QFrame(groupBox_2);
        frame_ThorMeter->setObjectName("frame_ThorMeter");
        sizePolicy2.setHeightForWidth(frame_ThorMeter->sizePolicy().hasHeightForWidth());
        frame_ThorMeter->setSizePolicy(sizePolicy2);
        frame_ThorMeter->setMinimumSize(QSize(250, 0));
        frame_ThorMeter->setMaximumSize(QSize(250, 16777215));
        layoutPower_2 = new QHBoxLayout(frame_ThorMeter);
        layoutPower_2->setSpacing(3);
        layoutPower_2->setObjectName("layoutPower_2");
        layoutPower_2->setContentsMargins(2, 2, 2, 2);
        labelPowerTitle_4 = new QLabel(frame_ThorMeter);
        labelPowerTitle_4->setObjectName("labelPowerTitle_4");
        QSizePolicy sizePolicy5(QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Fixed);
        sizePolicy5.setHorizontalStretch(0);
        sizePolicy5.setVerticalStretch(0);
        sizePolicy5.setHeightForWidth(labelPowerTitle_4->sizePolicy().hasHeightForWidth());
        labelPowerTitle_4->setSizePolicy(sizePolicy5);
        labelPowerTitle_4->setFont(font8);
        labelPowerTitle_4->setAlignment(Qt::AlignmentFlag::AlignCenter);
        labelPowerTitle_4->setMargin(0);
        labelPowerTitle_4->setIndent(4);

        layoutPower_2->addWidget(labelPowerTitle_4);

        lbl_measPower = new QLabel(frame_ThorMeter);
        lbl_measPower->setObjectName("lbl_measPower");
        sizePolicy.setHeightForWidth(lbl_measPower->sizePolicy().hasHeightForWidth());
        lbl_measPower->setSizePolicy(sizePolicy);
        lbl_measPower->setFont(font9);
        lbl_measPower->setAlignment(Qt::AlignmentFlag::AlignCenter);

        layoutPower_2->addWidget(lbl_measPower);

        lblUnit_4 = new QLabel(frame_ThorMeter);
        lblUnit_4->setObjectName("lblUnit_4");
        sizePolicy2.setHeightForWidth(lblUnit_4->sizePolicy().hasHeightForWidth());
        lblUnit_4->setSizePolicy(sizePolicy2);
        lblUnit_4->setFont(font8);

        layoutPower_2->addWidget(lblUnit_4);

        layoutPower_2->setStretch(0, 4);
        layoutPower_2->setStretch(1, 5);
        layoutPower_2->setStretch(2, 2);

        verticalLayout_5->addWidget(frame_ThorMeter);
        ...
        horizontalLayout_39->addWidget(groupBox_2);
        ...
        sizePolicy5.setHeightForWidth(lblDAC_add->sizePolicy().hasHeightForWidth());
        lblDAC_add->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lblDAC_range->sizePolicy().hasHeightForWidth());
        lblDAC_range->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lblLDfit_a->sizePolicy().hasHeightForWidth());
        lblLDfit_a->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lblLDfit_b->sizePolicy().hasHeightForWidth());
        lblLDfit_b->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lblLaser_fit_a->sizePolicy().hasHeightForWidth());
        lblLaser_fit_a->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lblLaser_fit_b->sizePolicy().hasHeightForWidth());
        lblLaser_fit_b->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lblFit_dvide->sizePolicy().hasHeightForWidth());
        lblFit_dvide->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lblLow_tol->sizePolicy().hasHeightForWidth());
        lblLow_tol->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lblHigh_tol->sizePolicy().hasHeightForWidth());
        lblHigh_tol->setSizePolicy(sizePolicy5);
        ...
        lineEdit_command = new QLineEdit(groupBox);
        lineEdit_command->setObjectName("lineEdit_command");
        sizePolicy3.setHeightForWidth(lineEdit_command->sizePolicy().hasHeightForWidth());
        lineEdit_command->setSizePolicy(sizePolicy3);

        horizontalLayout_10->addWidget(lineEdit_command);

        btnMSend = new QPushButton(groupBox);
        ...
        lblStatusMeter_2->setFont(font11);
        ...
        sizePolicy5.setHeightForWidth(labelPowerTitle_2->sizePolicy().hasHeightForWidth());
        labelPowerTitle_2->setSizePolicy(sizePolicy5);
        QFont font12;
        font12.setPointSize(33);
        labelPowerTitle_2->setFont(font12);
        ...
        labelInterval->setFont(font11);

        layoutInterval_2->addWidget(labelInterval);

        spn_LaserMInterval = new QSpinBox(centralwidget_3);
        spn_LaserMInterval->setObjectName("spn_LaserMInterval");
        spn_LaserMInterval->setFont(font11);
        spn_LaserMInterval->setMinimum(50);
        spn_LaserMInterval->setMaximum(10000);
        spn_LaserMInterval->setSingleStep(50);
        spn_LaserMInterval->setValue(200);

        layoutInterval_2->addWidget(spn_LaserMInterval);
        ...
        groupBox1 = new QGroupBox(tabConnect);
        groupBox1->setObjectName("groupBox1");
        groupBox1->setFont(font1);
        verticalLayout_12 = new QVBoxLayout(groupBox1);
        verticalLayout_12->setObjectName("verticalLayout_12");
        verticalLayout_12->setContentsMargins(5, 11, 5, 11);
        labConStatus = new QLabel(groupBox1);
        labConStatus->setObjectName("labConStatus");
        labConStatus->setFont(font11);

        verticalLayout_12->addWidget(labConStatus);

        tabConSwitch = new QTabWidget(groupBox1);
        ...
        btnLConnect = new QPushButton(groupBox1);
        btnLConnect->setObjectName("btnLConnect");
        btnLConnect->setFont(font11);

        horizontalLayout_23->addWidget(btnLConnect);

        lbStatus = new QLabel(groupBox1);
        lbStatus->setObjectName("lbStatus");
        lbStatus->setFont(font11);
        lbStatus->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        verticalLayout_12->setStretch(3, 2);

        horizontalLayout_22->addWidget(groupBox1);
        ...
        lblStatusMeter_3->setFont(font11);

        verticalLayout_11->addWidget(lblStatusMeter_3);

        horizontalLayout_24 = new QHBoxLayout();
        horizontalLayout_24->setObjectName("horizontalLayout_24");
        lbl_Device = new QLabel(gb_LASERPOINT);
        lbl_Device->setObjectName("lbl_Device");
        lbl_Device->setFont(font11);

        horizontalLayout_24->addWidget(lbl_Device);

        spn_LASERPOINT = new QSpinBox(gb_LASERPOINT);
        spn_LASERPOINT->setObjectName("spn_LASERPOINT");
        spn_LASERPOINT->setFont(font11);
        ...
        verticalLayout_24 = new QVBoxLayout(frame_LASERPOINT);
        verticalLayout_24->setObjectName("verticalLayout_24");
        lbl_LaserPointIfo = new QLabel(frame_LASERPOINT);
        lbl_LaserPointIfo->setObjectName("lbl_LaserPointIfo");
        lbl_LaserPointIfo->setFont(font11);
        lbl_LaserPointIfo->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignTop);

        verticalLayout_24->addWidget(lbl_LaserPointIfo);
        ...
        verticalLayout_15 = new QVBoxLayout(gb_ThorlabMeter);
        ...
        lb_ThorlabMeter->setFont(font11);

        horizontalLayout_32->addWidget(lb_ThorlabMeter);

        btn_ThorLabsMeterScan = new QPushButton(gb_ThorlabMeter);
        btn_ThorLabsMeterScan->setObjectName("btn_ThorLabsMeterScan");
        sizePolicy5.setHeightForWidth(btn_ThorLabsMeterScan->sizePolicy().hasHeightForWidth());
        btn_ThorLabsMeterScan->setSizePolicy(sizePolicy5);
        btn_ThorLabsMeterScan->setMinimumSize(QSize(40, 40));
        btn_ThorLabsMeterScan->setMaximumSize(QSize(40, 40));
        QFont font14;
        font14.setPointSize(8);
        btn_ThorLabsMeterScan->setFont(font14);

        horizontalLayout_32->addWidget(btn_ThorLabsMeterScan);
        ...
        lbl_ThoDeviceName = new QLabel(gb_ThorlabMeter);
        lbl_ThoDeviceName->setObjectName("lbl_ThoDeviceName");
        lbl_ThoDeviceName->setFont(font11);

        horizontalLayout_18->addWidget(lbl_ThoDeviceName);

        cbB_ThorlabMeter = new QComboBox(gb_ThorlabMeter);
        cbB_ThorlabMeter->setObjectName("cbB_ThorlabMeter");
        cbB_ThorlabMeter->setFont(font11);
        ...
        btn_ThorlabMeter->setFont(font11);

        horizontalLayout_18->addWidget(btn_ThorlabMeter);

        horizontalLayout_18->setStretch(1, 7);
        ...
        verticalLayout_25 = new QVBoxLayout(frame_ThorlabMet);
        verticalLayout_25->setObjectName("verticalLayout_25");
        lbl_ThoDeviceIfo = new QLabel(frame_ThorlabMet);
        lbl_ThoDeviceIfo->setObjectName("lbl_ThoDeviceIfo");
        lbl_ThoDeviceIfo->setFont(font11);
        lbl_ThoDeviceIfo->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignTop);

        verticalLayout_25->addWidget(lbl_ThoDeviceIfo);


        verticalLayout_15->addWidget(frame_ThorlabMet);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        gb_PowerCheck_3->setTitle(QCoreApplication::translate("MainWindow", "LaserPower Meter", nullptr));
        ...
        groupBox_3->setTitle(QCoreApplication::translate("MainWindow", "ThorLabs Meter", nullptr));
        labelPowerTitle_5->setText(QCoreApplication::translate("MainWindow", "\345\212\237\347\216\207\357\274\232", nullptr));
        lbl_measPower_2->setText(QCoreApplication::translate("MainWindow", "--.-", nullptr));
        lblUnit_5->setText(QCoreApplication::translate("MainWindow", "W", nullptr));
...
"Time", nullptr));
        ...
        centralwidget_2->setTitle(QCoreApplication::translate("MainWindow", "LaserPower Meter", nullptr));
        ...
        groupBox_2->setTitle(QCoreApplication::translate("MainWindow", "ThorLabs Meter", nullptr));
        lblStatusMeter_4->setText(QCoreApplication::translate("MainWindow", "\347\213\200\346\205\213\357\274\232\346\234\252\351\200\243\347\267\232", nullptr));
        labelPowerTitle_4->setText(QCoreApplication::translate("MainWindow", "\345\212\237\347\216\207\357\274\232", nullptr));
        lbl_measPower->setText(QCoreApplication::translate("MainWindow", "--.-", nullptr));
        lblUnit_4->setText(QCoreApplication::translate("MainWindow", "W", nullptr));
        ...
        centralwidget_3->setTitle(QCoreApplication::translate("MainWindow", "LaserPoint Meter", nullptr));
        ...
        groupBox1->setTitle(QCoreApplication::translate("MainWindow", "LASER DEVICE", nullptr));
        labConStatus->setText(QCoreApplication::translate("MainWindow", "\347\213\200\346\205\213: Disconnect", nullptr));
        ...
        lbl_Device->setText(QCoreApplication::translate("MainWindow", "Device Index\357\274\232", nullptr));
        btn_LASERPOINT->setText(QCoreApplication::translate("MainWindow", "Connect", nullptr));
        lbl_LaserPointIfo->setText(QString());
        ...
        btn_ThorLabsMeterScan->setText(QCoreApplication::translate("MainWindow", "Scan", nullptr));
        lbl_ThoDeviceName->setText(QCoreApplication::translate("MainWindow", "Device Name:", nullptr));
        btn_ThorlabMeter->setText(QCoreApplication::translate("MainWindow", "Connect", nullptr));
        lbl_ThoDeviceIfo->setText(QString());
