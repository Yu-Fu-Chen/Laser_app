...
void Simulation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->ledStateChange((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        case 1: _t->setConnect((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Simulation::*)(int , bool )>(_a, &Simulation::ledStateChange, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Simulation::*)(QString )>(_a, &Simulation::setConnect, 1))
            return;
    }
}
...
// SIGNAL 0
void Simulation::ledStateChange(int _t1, bool _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void Simulation::setConnect(QString _t1)
{
